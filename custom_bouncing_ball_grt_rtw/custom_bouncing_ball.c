...
void custom_bouncing_ball_step(void)
{
  ...
  if (rtmIsMajorTimeStep(custom_bouncing_ball_M)) {
    ...
    if (custom_bouncing_ball_DW.InitialVelocity_FirstOutputTime) {
       ...
       *  Memory: '<Root>/Memory'
       */
      custom_bouncing_ball_B.InitialVelocity = custom_bouncing_ball_P.r *
  ...
  if (rtmIsMajorTimeStep(custom_bouncing_ball_M)) {
    /* Matfile logging */
    rt_UpdateTXYLogVars(custom_bouncing_ball_M->rtwLogInfo,
                        (custom_bouncing_ball_M->Timing.t));
  }                                    /* end MajorTimeStep */
  ...
  if (rtmIsMajorTimeStep(custom_bouncing_ball_M)) {
    ...
    {                                  /* Sample time: [0.0s, 0.0s] */
      if ((rtmGetTFinal(custom_bouncing_ball_M)!=-1) &&
          !((rtmGetTFinal(custom_bouncing_ball_M)-
             (((custom_bouncing_ball_M->Timing.clockTick1+
                custom_bouncing_ball_M->Timing.clockTickH1* 4294967296.0)) * 0.2))
            > (((custom_bouncing_ball_M->Timing.clockTick1+
                 custom_bouncing_ball_M->Timing.clockTickH1* 4294967296.0)) *
               0.2) * (DBL_EPSILON))) {
        rtmSetErrorStatus(custom_bouncing_ball_M, "Simulation finished");
      }
    }
...
void custom_bouncing_ball_initialize(void)
{
  ...
  rtmSetTFinal(custom_bouncing_ball_M, 10.0);
  ...
  /* Setup for data logging */
  {
    ...
    custom_bouncing_ball_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(custom_bouncing_ball_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(custom_bouncing_ball_M->rtwLogInfo, (NULL));
    rtliSetLogT(custom_bouncing_ball_M->rtwLogInfo, "tout");
    rtliSetLogX(custom_bouncing_ball_M->rtwLogInfo, "");
    rtliSetLogXFinal(custom_bouncing_ball_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(custom_bouncing_ball_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(custom_bouncing_ball_M->rtwLogInfo, 4);
    rtliSetLogMaxRows(custom_bouncing_ball_M->rtwLogInfo, 0);
    rtliSetLogDecimation(custom_bouncing_ball_M->rtwLogInfo, 1);
    rtliSetLogY(custom_bouncing_ball_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(custom_bouncing_ball_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(custom_bouncing_ball_M->rtwLogInfo, (NULL));
  }
  ...
  /* Matfile logging */
  rt_StartDataLoggingWithStartTime(custom_bouncing_ball_M->rtwLogInfo, 0.0,
    rtmGetTFinal(custom_bouncing_ball_M),
    custom_bouncing_ball_M->Timing.stepSize0, (&rtmGetErrorStatus
    (custom_bouncing_ball_M)));
